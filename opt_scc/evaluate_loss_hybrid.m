function [ Ploss, L_out, Eff , Pssl, Pfsl, Psw, Pout] = ...
            evaluate_loss_hybrid(implementation,fsw,Ac,Asw,...
            Vin,Io,Io_ac)
...
Pout = Vin.*implementation.topology.ratio.* Io;

Eff = min( Pout./(Pout+Ploss));
